/* Emmanuel Shiferaw
 * Enables stereo for skybox
 * obtained from Unity Support Forums
 * user "Nora"
 */
using UnityEngine;
...
public class SkyboxMesh : MonoBehaviour
{
	...
	void Awake()
	{
		...
		if( this.material == null ) {
			...
			//this.material = new Material( _shaderText ); //obsolete way of creating shader - DJZ
			Shader shader=Shader.Find("SkyboxMesh Background");
		...
		UnityEngine.Debug.Log("Skybox setup time: " + elapsedTime.ToString() +" ms");
	}
